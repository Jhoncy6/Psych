...
<form class="card" action = "paciente/cadastroBDpaciente.php" method="POST">
				...
				<div class="col-md-6" >
					...
					<input type="email" name="username" required placeholder="Digite seu email" class="form-control"> 
				</span>
				 	
					<label style="font-family: verdana;">Senha</label>
					<input type="password" name="password" placeholder="Digite sua senha" required class="form-control
					 ">
